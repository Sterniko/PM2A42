...
public class VorstellungTest {
	...
	public void setUp() {
		...
		_hdR1 = new Film("Der Herr der Ringe - Die Gefhrten", 178, FSK.FSK12, true);
	}

	@Test
	public void testeKonstruktor() {
		Vorstellung v = new Vorstellung(_kinoA, _hdR1, _16_45, _20_15, _11_07_2008, new Geldbetrag(1230));
		...
		assertEquals(1230, v.getPreis().getGeldbetrag());
	...
	public void testHatPlatzHatPlaetze() {
		...
		// Bei leerer Menge sollte hatPlaetze
		// true zurückgeben
		...
		// Bei mindestens einem ungültigen Platz
		// muss false kommen
	...
	public void testeGibPreisFuerPlaetze() {
		...
		assertEquals(0, v.getPreisFuerPlaetze(s).getGeldbetrag());

		s.add(Platz.get(5, 5));
		s.add(Platz.get(5, 6));
		s.add(Platz.get(5, 7));

		assertEquals(3690, v.getPreisFuerPlaetze(s).getGeldbetrag());
	}
