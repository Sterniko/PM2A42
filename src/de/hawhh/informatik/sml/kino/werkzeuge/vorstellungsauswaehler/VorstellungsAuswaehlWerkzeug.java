...
public class VorstellungsAuswaehlWerkzeug extends ObservableSubwerkzeug {
	...
	public Vorstellung getAusgewaehlteVorstellung() {
		...
		VorstellungsFormatierer adapter = (VorstellungsFormatierer) _ui.getVorstellungAuswahlList().getSelectionModel()
				.getSelectedItem();
		if (adapter != null) {
	...
	private void registriereUIAktionen() {
		...
		// });
		_ui.getVorstellungAuswahlList().getSelectionModel().selectedItemProperty()
				.addListener(new ChangeListener<VorstellungsFormatierer>() {
					@Override
					public void changed(ObservableValue<? extends VorstellungsFormatierer> arg0,
							VorstellungsFormatierer arg1, VorstellungsFormatierer arg2) {
